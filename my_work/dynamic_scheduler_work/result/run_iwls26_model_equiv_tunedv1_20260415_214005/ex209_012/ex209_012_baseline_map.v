// Benchmark "iwls26/results/ex209_012" written by ABC on Wed Apr 15 21:56:05 2026
...
module \iwls26/results/ex209_012  ( 
  ...
  AOI22_X1  g024(.A1(pi03), .A2(new_n48), .B1(new_n56), .B2(pi07), .ZN(new_n57));
  ...
  NAND3_X1  g033(.A1(new_n64), .A2(new_n49), .A3(new_n65), .ZN(new_n66));
  ...
  NAND2_X1  g071(.A1(new_n50), .A2(pi03), .ZN(new_n104));
  ...
  NAND2_X1  g081(.A1(new_n48), .A2(pi04), .ZN(new_n114));
  OAI21_X1  g082(.A(new_n113), .B1(new_n71), .B2(new_n114), .ZN(new_n115));
  NOR2_X1   g083(.A1(new_n50), .A2(new_n92), .ZN(new_n116));
  ...
  NAND2_X1  g092(.A1(new_n124), .A2(new_n50), .ZN(new_n125));
  ...
  OAI22_X1  g099(.A1(new_n48), .A2(pi06), .B1(pi03), .B2(pi04), .ZN(new_n132));
  ...
  NAND3_X1  g105(.A1(new_n48), .A2(new_n50), .A3(pi03), .ZN(new_n138));
  ...
  NAND3_X1  g109(.A1(new_n34), .A2(new_n48), .A3(pi01), .ZN(new_n142));
  ...
  NOR3_X1   g123(.A1(new_n37), .A2(new_n48), .A3(pi03), .ZN(new_n156));
  ...
  NOR2_X1   g134(.A1(new_n50), .A2(new_n56), .ZN(new_n167));
  ...
  NAND2_X1  g139(.A1(new_n171), .A2(new_n50), .ZN(new_n172));
  ...
  OAI22_X1  g157(.A1(new_n48), .A2(pi07), .B1(pi00), .B2(pi01), .ZN(new_n190));
  ...
  NAND2_X1  g162(.A1(new_n48), .A2(pi01), .ZN(new_n195));
  ...
  OAI21_X1  g173(.A(new_n48), .B1(new_n42), .B2(pi01), .ZN(new_n206));
  NAND3_X1  g174(.A1(new_n206), .A2(new_n106), .A3(new_n205), .ZN(new_n207));
  NAND2_X1  g175(.A1(new_n76), .A2(new_n97), .ZN(new_n208));
  NOR2_X1   g176(.A1(new_n74), .A2(pi05), .ZN(new_n209));
  AOI22_X1  g177(.A1(new_n209), .A2(new_n34), .B1(new_n42), .B2(new_n37), .ZN(new_n210));
  NAND3_X1  g178(.A1(new_n70), .A2(new_n74), .A3(pi05), .ZN(new_n211));
  NAND4_X1  g179(.A1(new_n208), .A2(new_n210), .A3(new_n207), .A4(new_n211), .ZN(new_n212));
  NAND2_X1  g180(.A1(pi03), .A2(pi06), .ZN(new_n213));
  NOR2_X1   g181(.A1(new_n134), .A2(new_n49), .ZN(new_n214));
  ...
  AOI21_X1  g185(.A(new_n209), .B1(new_n49), .B2(new_n51), .ZN(new_n218));
  ...
  AOI21_X1  g222(.A(new_n210), .B1(new_n138), .B2(new_n226), .ZN(new_n255));
  ...
  NAND2_X1  g229(.A1(new_n170), .A2(new_n74), .ZN(new_n262));
  NAND2_X1  g230(.A1(new_n34), .A2(pi06), .ZN(new_n263));
  AOI21_X1  g231(.A(new_n112), .B1(new_n104), .B2(new_n263), .ZN(new_n264));
  OAI21_X1  g232(.A(new_n262), .B1(new_n264), .B2(new_n167), .ZN(new_n265));
  NOR2_X1   g233(.A1(new_n48), .A2(pi06), .ZN(new_n266));
  NOR2_X1   g234(.A1(new_n97), .A2(new_n266), .ZN(new_n267));
  AOI22_X1  g235(.A1(new_n267), .A2(new_n170), .B1(pi04), .B2(new_n113), .ZN(new_n268));
  NAND2_X1  g236(.A1(new_n268), .A2(new_n265), .ZN(new_n269));
  NOR2_X1   g237(.A1(new_n182), .A2(new_n213), .ZN(new_n270));
  INV_X1    g238(.A(new_n85), .ZN(new_n271));
  NAND3_X1  g239(.A1(new_n271), .A2(pi00), .A3(new_n67), .ZN(new_n272));
  OAI21_X1  g240(.A(new_n93), .B1(new_n272), .B2(new_n270), .ZN(new_n273));
  INV_X1    g241(.A(new_n273), .ZN(new_n274));
  AOI21_X1  g242(.A(new_n274), .B1(new_n269), .B2(new_n261), .ZN(new_n275));
  NAND2_X1  g243(.A1(new_n34), .A2(pi08), .ZN(new_n276));
  NOR2_X1   g244(.A1(new_n266), .A2(new_n276), .ZN(new_n277));
  INV_X1    g245(.A(new_n179), .ZN(new_n278));
  NAND2_X1  g246(.A1(new_n262), .A2(new_n225), .ZN(new_n279));
  NAND3_X1  g247(.A1(new_n279), .A2(new_n50), .A3(new_n278), .ZN(new_n280));
  AND2_X1   g248(.A1(new_n280), .A2(new_n277), .ZN(new_n281));
  NOR2_X1   g249(.A1(new_n223), .A2(new_n56), .ZN(new_n282));
  NAND2_X1  g250(.A1(new_n34), .A2(new_n37), .ZN(new_n283));
  NOR2_X1   g251(.A1(new_n283), .A2(new_n262), .ZN(new_n284));
  OAI221_X1 g252(.A(pi07), .B1(new_n282), .B2(new_n284), .C1(new_n280), .C2(new_n277), .ZN(new_n285));
  OAI21_X1  g253(.A(new_n42), .B1(new_n285), .B2(new_n281), .ZN(new_n286));
  NAND2_X1  g254(.A1(new_n192), .A2(new_n187), .ZN(new_n287));
  AOI21_X1  g255(.A(new_n260), .B1(new_n287), .B2(pi02), .ZN(new_n288));
  AOI21_X1  g256(.A(new_n182), .B1(new_n135), .B2(new_n279), .ZN(new_n289));
  NOR2_X1   g257(.A1(new_n48), .A2(new_n92), .ZN(new_n290));
  INV_X1    g258(.A(new_n290), .ZN(new_n291));
  AOI21_X1  g259(.A(new_n283), .B1(new_n62), .B2(new_n291), .ZN(new_n292));
  NAND2_X1  g260(.A1(new_n283), .A2(pi07), .ZN(new_n293));
  NAND2_X1  g261(.A1(new_n293), .A2(new_n167), .ZN(new_n294));
  NOR2_X1   g262(.A1(new_n37), .A2(pi05), .ZN(new_n295));
  NOR2_X1   g263(.A1(pi00), .A2(pi01), .ZN(new_n296));
  AOI21_X1  g264(.A(new_n296), .B1(new_n295), .B2(new_n194), .ZN(new_n297));
  NAND3_X1  g265(.A1(new_n294), .A2(new_n180), .A3(new_n297), .ZN(new_n298));
  OAI21_X1  g266(.A(new_n298), .B1(new_n289), .B2(new_n292), .ZN(new_n299));
  OAI21_X1  g267(.A(pi00), .B1(new_n209), .B2(new_n61), .ZN(new_n300));
  INV_X1    g268(.A(new_n300), .ZN(new_n301));
  NAND3_X1  g269(.A1(new_n106), .A2(pi01), .A3(new_n37), .ZN(new_n302));
  OAI211_X1 g270(.A(new_n302), .B(new_n183), .C1(new_n92), .C2(new_n263), .ZN(new_n303));
  NAND2_X1  g271(.A1(new_n74), .A2(pi07), .ZN(new_n304));
  NAND2_X1  g272(.A1(new_n74), .A2(pi05), .ZN(new_n305));
  NAND4_X1  g273(.A1(new_n142), .A2(new_n42), .A3(new_n304), .A4(new_n305), .ZN(new_n306));
  NOR2_X1   g274(.A1(new_n92), .A2(pi02), .ZN(new_n307));
  NOR3_X1   g275(.A1(new_n307), .A2(pi06), .A3(new_n296), .ZN(new_n308));
  NOR2_X1   g276(.A1(new_n308), .A2(new_n306), .ZN(new_n309));
  AOI21_X1  g277(.A(new_n309), .B1(new_n301), .B2(new_n303), .ZN(new_n310));
  NAND2_X1  g278(.A1(new_n310), .A2(new_n299), .ZN(new_n311));
  OAI22_X1  g279(.A1(new_n286), .A2(new_n275), .B1(new_n311), .B2(new_n288), .ZN(new_n312));
  INV_X1    g280(.A(new_n180), .ZN(new_n313));
  NAND4_X1  g281(.A1(new_n273), .A2(new_n268), .A3(new_n265), .A4(new_n313), .ZN(new_n314));
  ...
  OAI21_X1  g286(.A(new_n170), .B1(new_n49), .B2(new_n181), .ZN(new_n319));
  NAND3_X1  g287(.A1(new_n97), .A2(new_n283), .A3(pi00), .ZN(new_n320));
  ...
  NAND2_X1  g306(.A1(new_n37), .A2(new_n50), .ZN(new_n339));
  OAI221_X1 g307(.A(new_n339), .B1(new_n103), .B2(new_n50), .C1(new_n209), .C2(new_n34), .ZN(new_n340));
  OR2_X1    g308(.A1(new_n124), .A2(new_n251), .ZN(new_n341));
  OAI211_X1 g309(.A(new_n85), .B(new_n246), .C1(new_n97), .C2(new_n177), .ZN(new_n342));
  OAI211_X1 g310(.A(new_n342), .B(new_n341), .C1(new_n340), .C2(new_n306), .ZN(new_n343));
  ...
  NOR2_X1   g330(.A1(new_n50), .A2(pi03), .ZN(new_n363));
  ...
  OAI21_X1  g337(.A(pi08), .B1(new_n325), .B2(new_n296), .ZN(new_n370));
  AOI22_X1  g338(.A1(new_n190), .A2(new_n54), .B1(new_n209), .B2(pi07), .ZN(new_n371));
  ...
  AOI21_X1  g349(.A(new_n210), .B1(new_n105), .B2(new_n107), .ZN(new_n382));
  ...
  AOI21_X1  g353(.A(new_n56), .B1(new_n378), .B2(new_n379), .ZN(new_n386));
  AOI21_X1  g354(.A(new_n67), .B1(new_n260), .B2(new_n216), .ZN(new_n387));
  OAI21_X1  g355(.A(new_n387), .B1(new_n297), .B2(new_n105), .ZN(new_n388));
  OAI211_X1 g356(.A(pi04), .B(new_n56), .C1(new_n170), .C2(pi03), .ZN(new_n389));
  NAND3_X1  g357(.A1(new_n389), .A2(new_n278), .A3(new_n276), .ZN(new_n390));
  AOI21_X1  g358(.A(new_n48), .B1(new_n283), .B2(pi06), .ZN(new_n391));
  NOR2_X1   g359(.A1(new_n390), .A2(new_n391), .ZN(new_n392));
  NOR2_X1   g360(.A1(new_n194), .A2(new_n179), .ZN(new_n393));
  AOI22_X1  g361(.A1(new_n393), .A2(new_n389), .B1(new_n97), .B2(new_n283), .ZN(new_n394));
  OAI22_X1  g362(.A1(new_n388), .A2(new_n386), .B1(new_n392), .B2(new_n394), .ZN(new_n395));
  NAND2_X1  g363(.A1(new_n395), .A2(new_n307), .ZN(new_n396));
  ...
  OAI211_X1 g369(.A(pi02), .B(pi05), .C1(new_n50), .C2(pi00), .ZN(new_n402));
  ...
  OAI211_X1 g378(.A(new_n410), .B(new_n276), .C1(new_n60), .C2(new_n251), .ZN(new_n411));
  ...
  NAND2_X1  g382(.A1(new_n414), .A2(new_n396), .ZN(new_n415));
  ...
  NOR3_X1   g394(.A1(new_n80), .A2(new_n245), .A3(new_n179), .ZN(new_n427));
  OAI211_X1 g395(.A(new_n357), .B(new_n290), .C1(pi00), .C2(new_n373), .ZN(new_n428));
  OAI22_X1  g396(.A1(new_n428), .A2(new_n427), .B1(new_n49), .B2(new_n278), .ZN(new_n429));
  OAI21_X1  g397(.A(new_n429), .B1(new_n203), .B2(new_n296), .ZN(new_n430));
  ...
  NAND3_X1  g406(.A1(new_n273), .A2(new_n265), .A3(new_n268), .ZN(new_n439));
  NAND4_X1  g407(.A1(new_n36), .A2(new_n42), .A3(new_n262), .A4(new_n225), .ZN(new_n440));
  AOI21_X1  g408(.A(new_n440), .B1(new_n439), .B2(new_n69), .ZN(new_n441));
  INV_X1    g409(.A(new_n424), .ZN(new_n442));
  AOI21_X1  g410(.A(new_n121), .B1(new_n442), .B2(new_n327), .ZN(new_n443));
  NAND2_X1  g411(.A1(new_n104), .A2(new_n263), .ZN(new_n444));
  NOR2_X1   g412(.A1(new_n38), .A2(new_n179), .ZN(new_n445));
  NOR3_X1   g413(.A1(new_n445), .A2(new_n233), .A3(new_n444), .ZN(new_n446));
  NAND4_X1  g414(.A1(new_n446), .A2(new_n164), .A3(new_n166), .A4(new_n240), .ZN(new_n447));
  OAI211_X1 g415(.A(new_n42), .B(new_n301), .C1(new_n303), .C2(new_n131), .ZN(new_n448));
  OAI211_X1 g416(.A(new_n50), .B(pi08), .C1(new_n48), .C2(pi07), .ZN(new_n449));
  NAND2_X1  g417(.A1(new_n449), .A2(new_n251), .ZN(new_n450));
  NOR2_X1   g418(.A1(new_n191), .A2(pi04), .ZN(new_n451));
  AOI21_X1  g419(.A(new_n35), .B1(pi04), .B2(new_n209), .ZN(new_n452));
  NAND4_X1  g420(.A1(new_n262), .A2(new_n49), .A3(new_n51), .A4(pi02), .ZN(new_n453));
  OAI21_X1  g421(.A(pi02), .B1(new_n50), .B2(pi00), .ZN(new_n454));
  NAND4_X1  g422(.A1(new_n449), .A2(new_n454), .A3(new_n92), .A4(new_n134), .ZN(new_n455));
  OAI21_X1  g423(.A(new_n455), .B1(new_n452), .B2(new_n453), .ZN(new_n456));
  AOI21_X1  g424(.A(new_n456), .B1(new_n450), .B2(new_n451), .ZN(new_n457));
  NAND3_X1  g425(.A1(new_n457), .A2(new_n447), .A3(new_n448), .ZN(new_n458));
  NOR3_X1   g426(.A1(new_n458), .A2(new_n441), .A3(new_n443), .ZN(new_n459));
  NAND2_X1  g427(.A1(new_n399), .A2(new_n397), .ZN(new_n460));
  OAI21_X1  g428(.A(pi05), .B1(new_n80), .B2(new_n179), .ZN(new_n461));
  OAI21_X1  g429(.A(new_n42), .B1(new_n296), .B2(pi07), .ZN(new_n462));
  OAI21_X1  g430(.A(new_n358), .B1(new_n167), .B2(new_n266), .ZN(new_n463));
  NAND3_X1  g431(.A1(new_n463), .A2(new_n461), .A3(new_n462), .ZN(new_n464));
  OAI21_X1  g432(.A(new_n442), .B1(new_n464), .B2(new_n460), .ZN(new_n465));
  ...
  NAND3_X1  g436(.A1(new_n444), .A2(new_n139), .A3(new_n323), .ZN(new_n469));
  NAND3_X1  g437(.A1(new_n101), .A2(new_n109), .A3(new_n469), .ZN(new_n470));
  OAI21_X1  g438(.A(new_n211), .B1(new_n74), .B2(new_n213), .ZN(new_n471));
  AOI21_X1  g439(.A(new_n88), .B1(new_n471), .B2(new_n408), .ZN(new_n472));
  NOR3_X1   g440(.A1(new_n282), .A2(new_n327), .A3(new_n366), .ZN(new_n473));
  ...
  OAI22_X1  g457(.A1(new_n459), .A2(new_n467), .B1(new_n478), .B2(new_n489), .ZN(po03));
  ...
  OAI21_X1  g461(.A(new_n184), .B1(new_n50), .B2(new_n92), .ZN(new_n494));
  OAI21_X1  g462(.A(new_n304), .B1(new_n494), .B2(new_n493), .ZN(new_n495));
  ...
  AOI21_X1  g470(.A(pi08), .B1(new_n262), .B2(pi02), .ZN(new_n503));
  ...
  AOI21_X1  g477(.A(new_n296), .B1(new_n130), .B2(new_n234), .ZN(new_n510));
  ...
  NAND2_X1  g482(.A1(new_n262), .A2(new_n50), .ZN(new_n515));
  OAI211_X1 g483(.A(new_n37), .B(new_n163), .C1(new_n515), .C2(new_n307), .ZN(new_n516));
  OR2_X1    g484(.A1(new_n516), .A2(pi03), .ZN(new_n517));
  AOI21_X1  g485(.A(new_n231), .B1(new_n56), .B2(new_n517), .ZN(new_n518));
  AOI21_X1  g486(.A(new_n351), .B1(new_n518), .B2(new_n514), .ZN(new_n519));
  OAI21_X1  g487(.A(new_n519), .B1(new_n509), .B2(new_n505), .ZN(po04));
  NAND2_X1  g488(.A1(new_n229), .A2(new_n125), .ZN(new_n521));
  NAND4_X1  g489(.A1(new_n499), .A2(new_n39), .A3(new_n442), .A4(new_n500), .ZN(new_n522));
  AOI21_X1  g490(.A(new_n50), .B1(new_n507), .B2(new_n124), .ZN(new_n523));
  AOI21_X1  g491(.A(new_n521), .B1(new_n522), .B2(new_n523), .ZN(new_n524));
  AOI211_X1 g492(.A(new_n510), .B(new_n122), .C1(new_n62), .C2(new_n479), .ZN(new_n525));
  NAND2_X1  g493(.A1(new_n525), .A2(new_n126), .ZN(new_n526));
  INV_X1    g494(.A(new_n293), .ZN(new_n527));
  OAI21_X1  g495(.A(new_n516), .B1(new_n56), .B2(new_n527), .ZN(new_n528));
  NAND3_X1  g496(.A1(new_n123), .A2(new_n262), .A3(new_n422), .ZN(new_n529));
  AND3_X1   g497(.A1(new_n528), .A2(new_n499), .A3(new_n529), .ZN(new_n530));
  OAI21_X1  g498(.A(new_n526), .B1(new_n530), .B2(new_n48), .ZN(new_n531));
  OAI21_X1  g499(.A(new_n150), .B1(new_n531), .B2(new_n524), .ZN(new_n532));
  NAND2_X1  g500(.A1(new_n532), .A2(new_n250), .ZN(po05));
  INV_X1    g501(.A(new_n150), .ZN(new_n534));
  AOI21_X1  g502(.A(new_n525), .B1(new_n522), .B2(new_n523), .ZN(new_n535));
  OAI21_X1  g503(.A(new_n507), .B1(new_n479), .B2(new_n262), .ZN(new_n536));
  OR2_X1    g504(.A1(new_n536), .A2(new_n92), .ZN(new_n537));
  OAI211_X1 g505(.A(new_n250), .B(new_n537), .C1(new_n535), .C2(new_n534), .ZN(po06));
  NAND2_X1  g506(.A1(new_n525), .A2(new_n92), .ZN(new_n539));
  INV_X1    g507(.A(new_n539), .ZN(new_n540));
  OAI21_X1  g508(.A(new_n250), .B1(new_n540), .B2(pi14), .ZN(new_n541));
  INV_X1    g509(.A(new_n525), .ZN(new_n542));
  NAND3_X1  g510(.A1(new_n542), .A2(pi07), .A3(new_n536), .ZN(new_n543));
  NAND2_X1  g511(.A1(new_n541), .A2(new_n543), .ZN(po07));
  AOI21_X1  g512(.A(pi14), .B1(new_n539), .B2(pi08), .ZN(new_n545));
  OAI21_X1  g513(.A(new_n545), .B1(pi08), .B2(new_n539), .ZN(po08));
  OAI21_X1  g514(.A(pi09), .B1(new_n539), .B2(pi08), .ZN(new_n547));
  NAND2_X1  g515(.A1(new_n547), .A2(new_n248), .ZN(po09));
  OR2_X1    g516(.A1(pi10), .A2(pi14), .ZN(po10));
  OR2_X1    g517(.A1(pi11), .A2(pi14), .ZN(po11));
  OR2_X1    g518(.A1(pi12), .A2(pi14), .ZN(po12));
  OR2_X1    g519(.A1(pi13), .A2(pi14), .ZN(po13));
  NOR2_X1   g520(.A1(new_n537), .A2(new_n248), .ZN(po14));
  INV_X1    g521(.A(pi15), .ZN(new_n554));
  NOR2_X1   g522(.A1(po14), .A2(new_n554), .ZN(po15));
endmodule
