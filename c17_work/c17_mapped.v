// Benchmark "c17_work/C17" written by ABC on Mon Feb  2 16:18:21 2026
...
module C17 ( 
  ...
  INV_X1    g4(.A(\2GAT(1) ), .ZN(new_n12));
  INV_X1    g5(.A(\7GAT(4) ), .ZN(new_n13));
  AOI22_X1  g6(.A1(new_n12), .A2(new_n13), .B1(\3GAT(2) ), .B2(\6GAT(3) ), .ZN(\23GAT(9) ));
endmodule
