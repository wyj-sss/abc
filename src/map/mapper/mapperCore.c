...
/**Function*************************************************************
  ...
  Synopsis    [Performs technology mapping for K=2 one-to-one mapping.]

  Description [Same as Map_Mapping() but forces nVarsMax = 2 and uses
  Map_MappingCuts_OTO() for cut computation.]
